...
export default function CVPage() {
  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      <div className="no-print sticky top-0 z-10 flex items-center justify-between border-b border-[var(--color-border)] bg-[rgba(244,239,230,0.92)] px-6 py-3 backdrop-blur-md">
        <Link
          href="/"
